...
import { useTheme, emphasize, makeStyles as makeStyles$1 } from '@material-ui/core/styles';
...
import { Field, propTypes, reduxForm, change, arrayRemove, FieldArray, formValueSelector } from 'redux-form';
...
var SubmitButton = function SubmitButton(props) {
  ...
  return React.createElement(Button, buttonProps, renderProgress(isSubmitting, sizeCircularProgress, colorCircularProgress), props.children);
};
...
var TableFilterForm$1 = withStyles(styles$1)(connect(mapStateToProps, mapDispatchToProps)(TableFilterFormRedux));
...
function (_React$Component) {
  ...
  _createClass(BasicTable, [{
    ...
    value: function renderBody() {
      ...
      return React.createElement(TableBody, null, !autoPaginateItems ? this.items.map(this.renderRow) : this.items.slice(page * rowsPerPage, (page + 1) * rowsPerPage).map(this.renderRow));
    }
  }, {
