(function (global, factory) {
  ...
  (global = global || self, factory(global['material-ui-form-helpers'] = {}, global.React, global.core, global.autobind, global.reactColor, global.clsx, global.Select, global.styles$3, global.MenuItem, global.icons, global.PropTypes, global.InputAdornment, global.AccountCircle, global.isBoolean, global.CircularProgress, global.index, global.Button, global.Table$1, global.TableBody, global.TableCell, global.TableHead, global.TableRow, global.Paper, global.styles$4, global._$1, global.TablePagination, global.Chip, global.reduxForm, global.ClearIcon, global.AddCircleIcon, global.Typography, global.reactRedux, global.DatePicker));
}(this, (function (exports, React, core, autobind, reactColor, clsx, Select, styles$3, MenuItem, icons, PropTypes, InputAdornment, AccountCircle, isBoolean, CircularProgress, index, Button, Table$1, TableBody, TableCell, TableHead, TableRow, Paper, styles$4, _$1, TablePagination, Chip, reduxForm, ClearIcon, AddCircleIcon, Typography, reactRedux, DatePicker) { 'use strict';
  ...
  var useStyles$1 = index.makeStyles({
    progress: {
      marginRight: "5px"
    }
  });
  ...
  var SubmitButton = function SubmitButton(props) {
    ...
    return React__default.createElement(Button, props, renderProgress(props.is_submitting), props.children);
  };
  ...
  TableFilterForm = reduxForm.reduxForm({
    form: 'TableFilterForm'
  })(TableFilterForm);
  var TableFilterForm$1 = core.withStyles(styles$1)(reactRedux.connect(mapStateToProps, mapDispatchToProps)(TableFilterForm));
  ...
  function (_React$Component) {
    ...
    _createClass(BasicTable, [{
      ...
      value: function renderBody() {
        ...
        return React__default.createElement(TableBody, null, this.items.map(function (item, index) {
      ...
      value: function render() {
        ...
        }, this.renderSectionHeader(), this.renderHeader(), this.renderBody()), reloading && React__default.createElement(LoadingBox, null), reloading && React__default.createElement(core.LinearProgress, null), paginator && React__default.createElement(Paginator, this.state.paginationInfo));
      }
    }]);
